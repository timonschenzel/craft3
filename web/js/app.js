...
/* harmony import */ var _Timeline_vue__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Timeline.vue */ "./resources/js/components/Timeline.vue");
/* harmony import */ var _Communities_vue__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Communities.vue */ "./resources/js/components/Communities.vue");
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    Timeline: _Timeline_vue__WEBPACK_IMPORTED_MODULE_0__["default"],
    Communities: _Communities_vue__WEBPACK_IMPORTED_MODULE_1__["default"]
  },
  props: ['component'],
  data: function data() {
    return {};
...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/Communities.vue?vue&type=script&lang=js&":
/*!**********************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/Communities.vue?vue&type=script&lang=js& ***!
  \**********************************************************************************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _Community_vue__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Community.vue */ "./resources/js/components/Community.vue");
/* harmony import */ var _Timeline_vue__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Timeline.vue */ "./resources/js/components/Timeline.vue");
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    Community: _Community_vue__WEBPACK_IMPORTED_MODULE_1__["default"],
    Timeline: _Timeline_vue__WEBPACK_IMPORTED_MODULE_2__["default"]
  },
  created: function created() {
    var _this = this;

    graphqlClient.request("\n            {\n                entries (section:[community]) {\n                    ...on Community {\n                        title,\n                        url,\n                        id,\n                        dateCreated @date(as:\"d-m-Y\"),\n                        author {\n                            username,\n                        }\n                    }\n                }\n            }\n      ").then(function (response) {
      _this.communities = response.entries;
    });
    axios__WEBPACK_IMPORTED_MODULE_0___default.a.get('actions/subscription/subscription').then(function (_ref) {
      var data = _ref.data;
  ...
  methods: {
    loadCommunityTimeline: function loadCommunityTimeline(id) {
      this.selected = id;
    }
  },
  computed: {
    visibleCommunities: function visibleCommunities() {
      var _this2 = this;
      ...
      return this.communities.filter(function (community) {
        return community.id == _this2.selected;
      });
    }
  }
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    ...
    Event.$on('updateSubscriptions', function (subscriptions) {
      for (var i in subscriptions) {
        if (subscriptions[i] == _this.community.id) {
  ...
  methods: {
    subscribe: function subscribe() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('actions/subscription//subscribe/store', {
    ...
    unsubscribe: function unsubscribe() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('actions/subscription//subscribe/destroy', {
        community_id: this.community.id
      }).then(function (_ref2) {
        var data = _ref2.data;
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    store: function store() {
      ...
      this.loading = true;
      graphqlClient.request("\n            mutation createNewEntry($title: String, $body: String, $authorId: Int) {\n                upsertMessage(\n                    title:$title,\n                    body:$body,\n                    authorId:$authorId,\n                    community:".concat(this.community, ",\n                ) {\n                    ...on Message {\n                        title,\n                        url,\n                        body,\n                        postDate @date(as:\"d-m-Y\"),\n                        community {\n                            title,\n                            url\n                        },\n                        author {\n                            username,\n                        }\n                    }\n                }\n            }\n        "), {
        title: this.title,
        body: this.body,
        authorId: this.$root.$data.userId
      }).then(function (_ref) {
        var upsertMessage = _ref.upsertMessage;
        upsertMessage.community = upsertMessage.community[0];

        _this.$parent.$data.messages.unshift(upsertMessage);

        _this.title = null;
        _this.body = null;
        _this.loading = false;
        axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('actions/subscription/subscription/new-message', {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _NewMessage_vue__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./NewMessage.vue */ "./resources/js/components/NewMessage.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    NewMessage: _NewMessage_vue__WEBPACK_IMPORTED_MODULE_0__["default"],
  ...
  created: function created() {
    ...
    var message = graphqlClient.request("\n            {\n                entries (".concat(this.communityFilter, "section:[message]").concat(this.limitPart, ") {\n                    ...on Message {\n                        title,\n                        url,\n                        body,\n                        postDate @date(as:\"d-m-Y\"),\n                        community {\n                            title,\n                            url\n                        },\n                        author {\n                            username,\n                        }\n                    }\n                }\n            }\n      ")).then(function (response) {
      _this.messages = response.entries.map(function (entry) {
  ...
  computed: {
    ...
    communityFilter: function communityFilter() {
      if (!this.community) {
        return '';
      }

      return "relatedTo:[{element:".concat(this.community, "}], ");
    }
  }
});
...
var render = function() {
  ...
  return _c(
    "div",
    { staticClass: "w-full" },
    [_vm._t("default"), _vm._v(" "), _c(_vm.component, { tag: "component" })],
    2
  )
}
var staticRenderFns = []
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/Communities.vue?vue&type=template&id=8d01aca8&":
/*!**************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/Communities.vue?vue&type=template&id=8d01aca8& ***!
  \**************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var render = function() {
  ...
  return _c(
    "div",
    { staticClass: "flex font-sans h-full justify-center flex-col mt-4" },
    [
      !_vm.communities.length
        ? _c(
            ...
            {
              staticClass:
                "absolute flex h-screen items-center justify-center w-full",
              staticStyle: { top: "0", left: "0" }
            },
            [
              _c("i", {
                staticClass: "fas fa-9x fa-spin fa-spinner text-gray-500"
              })
            ]
          )
        : _vm._e(),
      ...
      _vm.selected
        ? _c("div", { staticClass: "flex justify-center" }, [
            _c(
              ...
              {
                staticClass:
                  "bg-blue-500 hover:bg-blue-800 text-white font-bold py-2 px-4 rounded mb-4 cursor-pointer",
                on: {
        ...
        : _vm._e(),
      _vm._v(" "),
      _vm._l(_vm.visibleCommunities, function(community) {
        return _c("div", { key: community.id }, [
          _c(
            "div",
            {
              staticClass:
                "bg-white max-w-md mx-auto mb-4 border border-grey-light rounded-lg w-full"
            },
            [
              _c("div", { staticClass: "flex p-4" }, [
                ...
                _c(
                  "div",
                  { staticClass: "px-2 pt-2 flex-grow" },
                  [
                    _c(
                      "header",
                      {
                        ...
                        on: {
                          click: function($event) {
                            return _vm.loadCommunityTimeline(community.id)
                          }
                        }
                      },
                      [
                        ...
                        _c(
                          ...
                          {
                            staticClass:
                              "text-xs text-grey flex items-center my-1"
                          },
                          [
                            _c("i", { staticClass: "far fa-user mr-1" }),
                            _vm._v(" "),
                            _c("span", { staticClass: "mr-1" }, [
                              _vm._v(_vm._s(community.author.username))
                            ]),
                            _vm._v(" "),
                            _c("i", {
                            ...
                            _vm._v(" "),
                            _c("span", [_vm._v(_vm._s(community.dateCreated))])
                          ]
                        )
                      ]
                    ),
                    _vm._v(" "),
                    _c("community", { attrs: { community: community } })
                  ],
                  1
                )
              ])
      ...
      _vm.selected
        ? _c(
            ...
            [
              _c("timeline", {
                attrs: { community: _vm.selected, limit: null }
              })
            ],
            1
          )
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "w-16 mr-2" }, [
      _c("img", {
        staticClass: "p-2 rounded rounded-full",
        attrs: { src: "header.jpg" }
      })
    ])
  }
]
...
var render = function() {
  ...
  return _c(
    "footer",
    { staticClass: "border-t border-grey-lighter text-sm flex" },
    [
      _vm.subscribed
        ? _c(
            "div",
            {
              staticClass:
                "block no-underline text-blue flex px-4 py-2 items-center hover:bg-grey-lighter"
            },
            [
              _c("i", {
                staticClass: "fas fa-bullhorn mr-2 text-teal-500 font-bold"
              }),
              _vm._v(" "),
              _c(
                "span",
        ...
        : _c(
            ...
            [
              ...
              _c(
                "span",
                { staticClass: "cursor-pointer", on: { click: _vm.subscribe } },
                [_vm._v("- Subscribe me")]
              )
            ]
          )
          ...
          _c("header", [
            _c(
              ...
              [
                ...
                _vm._v(" "),
                _c("span", { staticClass: "font-normal text-grey" }, [
                  _vm._v("@" + _vm._s(_vm.message.community.title))
                ])
              ]
            ),
            _vm._v(" "),
            _c(
              ...
              [
                ...
                _vm._v(" "),
                _c("span", { staticClass: "mr-1" }, [
                  _vm._v(_vm._s(_vm.message.author.username))
                ]),
                _vm._v(" "),
                _c("i", { staticClass: "far fa-calendar-alt mr-1" }),
                _vm._v(" "),
                _c("span", [_vm._v(_vm._s(_vm.message.postDate))])
              ]
            )
          ]),
          _vm._v(" "),
          _c("article", { staticClass: "py-4 text-grey-600" }, [
            _vm._v(
          ...
          _c(
            ...
            [
              _c(
                ...
                [
                  _c(
                    ...
                    {
                      staticClass:
                        "feather feather-thumbs-up h-6 w-6 mr-1 stroke-current",
                      attrs: {
              ...
              _c(
                ...
                {
                  staticClass:
                    "block no-underline text-black flex px-4 py-2 items-center hover:bg-grey-lighter",
                  attrs: { href: "#" }
                },
                [
                  _c(
                    ...
                    {
                      staticClass:
                        "feather feather-message-circle h-6 w-6 mr-1",
                      attrs: {
                        xmlns: "http://www.w3.org/2000/svg",
                        width: "24",
                        height: "24",
        ...
        _c("div", { staticClass: "px-2 pt-2 flex-grow" }, [
          ...
          _c("div", { staticClass: "mb-4" }, [
            ...
            _c("textarea", {
              ...
              staticClass:
                "shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline",
              attrs: { id: "body", placeholder: "Message" },
          ...
          _c("div", { staticClass: "flex" }, [
            !_vm.loading
              ...
              : _c(
                  ...
                  [
                    _c("i", {
                      staticClass: "fas fa-spin fa-spinner text-grey-light"
                    })
                  ]
                )
          ])
...
var graphqlRequest = __webpack_require__(/*! graphql-request */ "./node_modules/graphql-request/dist/src/index.js");

window.graphqlClient = new graphqlRequest.GraphQLClient('http://craft.test/graphql', {
  headers: {
...
var app = new vue__WEBPACK_IMPORTED_MODULE_0___default.a({
  ...
  created: function created() {
    ...
    axios__WEBPACK_IMPORTED_MODULE_1___default.a.get('api/session').then(function (_ref) {
      var data = _ref.data;
      _this.userId = parseInt(data.id);
...
/***/ "./resources/js/components/Communities.vue":
/*!*************************************************!*\
  !*** ./resources/js/components/Communities.vue ***!
  \*************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Communities_vue_vue_type_template_id_8d01aca8___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Communities.vue?vue&type=template&id=8d01aca8& */ "./resources/js/components/Communities.vue?vue&type=template&id=8d01aca8&");
/* harmony import */ var _Communities_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Communities.vue?vue&type=script&lang=js& */ "./resources/js/components/Communities.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport *//* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  _Communities_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _Communities_vue_vue_type_template_id_8d01aca8___WEBPACK_IMPORTED_MODULE_0__["render"],
  _Communities_vue_vue_type_template_id_8d01aca8___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/components/Communities.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./resources/js/components/Communities.vue?vue&type=script&lang=js&":
/*!**************************************************************************!*\
  !*** ./resources/js/components/Communities.vue?vue&type=script&lang=js& ***!
  \**************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Communities_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/babel-loader/lib??ref--4-0!../../../node_modules/vue-loader/lib??vue-loader-options!./Communities.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/Communities.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport */ /* harmony default export */ __webpack_exports__["default"] = (_node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Communities_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./resources/js/components/Communities.vue?vue&type=template&id=8d01aca8&":
/*!********************************************************************************!*\
  !*** ./resources/js/components/Communities.vue?vue&type=template&id=8d01aca8& ***!
  \********************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Communities_vue_vue_type_template_id_8d01aca8___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../node_modules/vue-loader/lib??vue-loader-options!./Communities.vue?vue&type=template&id=8d01aca8& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/Communities.vue?vue&type=template&id=8d01aca8&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Communities_vue_vue_type_template_id_8d01aca8___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Communities_vue_vue_type_template_id_8d01aca8___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
...
__webpack_require__(/*! /home/vagrant/code/craft/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /home/vagrant/code/craft/resources/sass/app.scss */"./resources/sass/app.scss");
